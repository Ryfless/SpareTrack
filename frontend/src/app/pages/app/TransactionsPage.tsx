...
import { ArrowDownRight, ArrowUpRight, Activity, ClipboardList, Loader2 } from "lucide-react";
      ...
      <Card className="overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody>
              {loading ? (
                <tr><td colSpan={7}><Skeleton className="h-48 m-4" /></td></tr>
              ) : filtered.length === 0 ? (
                ...
                return <tr key={trx.id} className="border-b border-slate-50 dark:border-slate-800/50 hover:bg-blue-50/30 dark:hover:bg-blue-900/10 transition-colors">
                  ...
                  <td className="px-4 py-3 text-xs text-slate-500 dark:text-slate-400">{trx.branch_name}</td>
